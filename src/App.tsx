...
function GridOffIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M4.75 18.25C4.75 18.6642 4.41421 19 4 19C3.58579 19 3.25 18.6642 3.25 18.25H4.75ZM10.75 18.25C10.75 18.6642 10.4142 19 10 19C9.58579 19 9.25 18.6642 9.25 18.25H10.75ZM16.75 18.25C16.75 18.6642 16.4142 19 16 19C15.5858 19 15.25 18.6642 15.25 18.25H16.75ZM18.25 15.25C18.6642 15.25 19 15.5858 19 16C19 16.4142 18.6642 16.75 18.25 16.75V15.25ZM1.75 15.25V16.75C1.33579 16.75 1 16.4142 1 16C1 15.5858 1.33579 15.25 1.75 15.25ZM4.75 15.25V16.75H3.25V15.25H4.75ZM7.75 15.25V16.75H6.25V15.25H7.75ZM10.75 15.25V16.75H9.25V15.25H10.75ZM13.75 15.25V16.75H12.25V15.25H13.75ZM16.75 15.25V16.75H15.25V15.25H16.75ZM4.75 12.25V13.75H3.25V12.25H4.75ZM10.75 12.25V13.75H9.25V12.25H10.75ZM16.75 12.25V13.75H15.25V12.25H16.75ZM18.25 9.25C18.6642 9.25 19 9.58579 19 10C19 10.4142 18.6642 10.75 18.25 10.75V9.25ZM1.75 9.25V10.75C1.33579 10.75 1 10.4142 1 10C1 9.58579 1.33579 9.25 1.75 9.25ZM4.75 9.25V10.75H3.25V9.25H4.75ZM7.75 9.25V10.75H6.25V9.25H7.75ZM10.75 9.25V10.75H9.25V9.25H10.75ZM13.75 9.25V10.75H12.25V9.25H13.75ZM16.75 9.25V10.75H15.25V9.25H16.75ZM4.75 6.25V7.75H3.25V6.25H4.75ZM10.75 6.25V7.75H9.25V6.25H10.75ZM16.75 6.25V7.75H15.25V6.25H16.75ZM18.25 3.25C18.6642 3.25 19 3.58579 19 4C19 4.41421 18.6642 4.75 18.25 4.75V3.25ZM1.75 3.25V4.75C1.33579 4.75 1 4.41421 1 4C1 3.58579 1.33579 3.25 1.75 3.25ZM4.75 3.25V4.75H3.25V3.25H4.75ZM7.75 3.25V4.75H6.25V3.25H7.75ZM10.75 3.25V4.75H9.25V3.25H10.75ZM13.75 3.25V4.75H12.25V3.25H13.75ZM16.75 3.25V4.75H15.25V3.25H16.75ZM4 1C4.41421 1 4.75 1.33579 4.75 1.75H3.25C3.25 1.33579 3.58579 1 4 1ZM10 1C10.4142 1 10.75 1.33579 10.75 1.75H9.25C9.25 1.33579 9.58579 1 10 1ZM16 1C16.4142 1 16.75 1.33579 16.75 1.75H15.25C15.25 1.33579 15.5858 1 16 1Z" fill="currentColor" />
    </svg>
  )
}
...
function App() {
  ...
  const hidden = murmurActive ? 'none' : undefined
  ...
  return (
    <>
      ...
      <div
        style={{
          display: murmurActive ? 'none' : 'flex',
